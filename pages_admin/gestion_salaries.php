...
<head>
    <link rel="stylesheet" href="../styles/gestion_salaries.css">
    ...
    <div class="container">
        ...
        <form id="salaries-form" method="POST" onsubmit="return confirmDeletion();">
            <div class="actions">
                ...
                <button id="modifier-btn" class="btn btn-secondary" type="button" disabled>Modifier un employé</button>
                <!-- Bouton pour supprimer les employés sélectionnés, désactivé par défaut -->
                <button id="supprimer-btn" class="btn btn-danger" type="submit" disabled>Supprimer les employés sélectionnés</button>
            </div>
                    ...
                    <?php if ($result->num_rows > 0) : ?>
                        <?php while ($row = $result->fetch_assoc()) : ?>
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" class="employee-checkbox" name="selected_ids[]" value="<?php echo htmlspecialchars($row['id_employe']); ?>">
                                </td>
